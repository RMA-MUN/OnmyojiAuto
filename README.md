...
### 直接下载exe程序的压缩包
[下载v1.5版本](https://github.com/RMA-MUN/OmnyojiAuto/releases/download/OAT-v1.5.1/OAT-v1.5.2.zip)
...
- 推荐使用**阴阳师桌面版**
- 确保程序以**管理员身份**运行
- 运行期间保持模拟器/游戏窗口可见(如果启用了后台模式，则保持窗口非最小化)
- 在1.4版本之后，程序运行过程中已经不在占用鼠标
...
6. 根据需求选择不同的客户端和是否启用后台运行模式，后台模式只支持桌面版，目前适配了官方的新桌面版。
